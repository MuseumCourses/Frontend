...
const slidesData = [
  {
    text: ' В 	ходе обучения студенты готовят групповые 	интеллектуальные проекты на основе 	предоставленных кейсов и запроса от 	региональных музеев.',
    imgSrc: Slider1,
  },
  {
    text: ' По 	итогу прохождения всей программы 	студент получает удостоверение о 	повышении квалификации.',
    imgSrc: Slider2,
  },
  {
    text: ' Занятия 	проходят на базе Института истории и 	международных ЮФУ (ул. Пушкинская 140) в 	г. Ростове-на-Дону при поддержке 	региональных музеев. Лекционные занятия 	проходят онлайн, практические – в очной 	форме.',
    imgSrc: Slider3,
  },
];
